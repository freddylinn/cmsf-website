  ...
  return (
    <div className="p-4 md:p-10 max-w-[1600px] mx-auto min-h-screen bg-white font-sans text-slate-900 text-left">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mb-20">
        ...
        <div className="lg:col-span-2"><textarea className="w-full border-2 border-slate-200 rounded-2xl p-6 min-h-[220px] outline-none" placeholder="Clinical Observations..."></textarea></div>
      </div>
      ...
      <div className="mt-20 p-8 bg-slate-50 rounded-3xl border-2 border-slate-200 no-print">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-8">
          ...
          <button onClick={() => { navigator.clipboard.writeText(generateSmartPhrase()); alert("Summary Copied!"); }} className="px-8 py-4 bg-sky-600 text-white font-black uppercase rounded-2xl shadow-lg hover:bg-sky-700 transition-all">Copy Smart Phrase</button>
        </div>
