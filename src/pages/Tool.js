...
if (values["value"] === "number") {
  ...
  return (
    <div className="">
      ...
      {/* 1. Action Buttons go here - exactly where you put them! */}
      <div className="flex flex-wrap gap-4 justify-center mt-8 mb-16 print:hidden">
        <button
          onClick={() => setHidden((prev) => !prev)}
          className="rounded-lg text-lg px-6 py-3 bg-sky-400 hover:bg-sky-500 active:bg-sky-600 text-white font-semibold transition-all shadow-md"
        >
